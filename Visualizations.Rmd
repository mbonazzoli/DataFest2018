...
ggmap(map) + geom_point(data = filtIndeedCity, aes(x = long, y = lat, size =  log(abs(Residual)), colour = Residual)) +
  scale_size(range = c(0.5, 7)) + 
  scale_colour_gradient2(midpoint = meanRes, low = 'red', mid = 'white', high = 'blue') + 
